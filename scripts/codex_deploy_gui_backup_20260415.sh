...
run_remote "cd /opt/docker/whereisit && sed -i 's#demon3434/where_is_it:[0-9]\\{8\\}#demon3434/where_is_it:${TAG}#g; s#demon3434/where_is_it:latest#demon3434/where_is_it:${TAG}#g' docker-compose.avahi.yml docker-compose.yml"
...
run_remote "cd /opt/docker/whereisit && WEB_PORT=\$(awk -F= '\$1==\"WEB_PORT\"{print \$2}' .env | tail -n1); curl -fsS http://127.0.0.1:\${WEB_PORT}/api/health"
